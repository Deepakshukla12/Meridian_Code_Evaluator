...
app = FastAPI()
# Enable CORS for deployed webste also
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:3000", 
        "https://evaluator-dusky.vercel.app"
    ],
...
async def submit_code(code: Code, email: str = Depends(verify_token)):
    ...
    try:
        # Enhanced system prompt for plagiarism detection
        system_prompt = """
        You are an advanced code plagiarism detection system designed to analyze and evaluate code submissions for potential plagiarism. Your expertise includes:

        1. **Detecting AI-Generated Code**:
           - Identify patterns typical of AI-generated code (e.g., ChatGPT, Claude, GitHub Copilot).
           - Look for overly consistent formatting, excessive comments, or unnatural variable naming.
           - Detect code that is overly optimized or uses advanced techniques unlikely for the student's level.

        2. **Identifying Copied Code**:
           - Recognize code snippets copied from common online sources (e.g., Stack Overflow, GitHub, GeeksforGeeks).
           - Flag code that matches known algorithms, functions, or solutions from tutorials or public repositories.
           - Detect inconsistent coding styles or mixed conventions that suggest multiple sources.

        3. **Assessing Originality**:
           - Evaluate the likelihood that the code was written by the student.
           - Identify common mistakes, incomplete implementations, or lack of understanding in the code.
           - Check for code that is too simplistic or lacks originality.

        4. **Providing Detailed Analysis**:
           - Break down the code into sections and analyze each part for plagiarism.
           - Provide a confidence score (0-100) for your assessment.
           - Highlight specific lines or blocks of code that are suspicious.

        5. **Generating Recommendations**:
           - Suggest follow-up questions to verify the student's understanding of the code.
           - Provide recommendations for improving the originality of the code.
        ...
        ```json
        {
            ...
            "red_flags": [
                "List of key concerns (e.g., inconsistent style, advanced techniques)"
            ],
        ...
        user_message = f"""
        Analyze this code for plagiarism:
        ...
        **Instructions**:
        ...
        4. Suggest follow-up questions to verify the student's understanding.
        5. Provide recommendations for improving originality and understanding.
        """
